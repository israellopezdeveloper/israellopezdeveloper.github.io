# src/editor/dialogs/university_dialog.py
...
class _FileSelectFallback(QtWidgets.QWidget):
    """Pequeño selector de archivo cuando no existe FileSelect."""
...
class UniversityDialog(QtWidgets.QDialog):
    ...
    def set_value(self, data: Dict[str, Any]) -> None:
        self._university.setText(_s(data.get("university_name")))
