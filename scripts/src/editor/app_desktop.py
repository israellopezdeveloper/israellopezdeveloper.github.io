...
#         enable_reorder(self.listSummary)
...
#         vb.addLayout(hb2)
#
#         # --- Hobbies: lista HTML (cada item en modal)
#         w_hobbies = QtWidgets.QWidget()
#         vh = QtWidgets.QVBoxLayout(w_hobbies)
#         self.listHobbies = QtWidgets.QListWidget()
#         enable_reorder(self.listHobbies)
#         btnAddH = QtWidgets.QPushButton("+")
#         btnDelH = QtWidgets.QPushButton("–")
#         btnEditH = QtWidgets.QPushButton("Editar HTML…")
#         btnAddH.clicked.connect(self._hobby_add)
#         btnDelH.clicked.connect(lambda: self._del_selected(self.listHobbies))
#         btnEditH.clicked.connect(lambda: self._edit_html_item(self.listHobbies))
#         hb_h = QtWidgets.QHBoxLayout()
#         hb_h.addWidget(btnAddH)
#         hb_h.addWidget(btnDelH)
#         hb_h.addWidget(btnEditH)
#         hb_h.addStretch(1)
#         vh.addWidget(self.listHobbies)
#         vh.addLayout(hb_h)
#
...
#         tabs.addTab(w_hobbies, "Hobbies (HTML, lista)")
...
#             )
#
#         self.listHobbies.clear()
#         for h in safe(intro, "hobbies", []):
#             self.listHobbies.addItem(str(h))
#
...
#             if isinstance(obj, dict):
#                 links.append(obj)
#         # hobbies (lista de HTML)
#         hobbies = [self.listHobbies.item(i).text() for i in range(self.listHobbies.count())]
#
...
#
#     def _hobby_add(self):
#         dlg = HtmlItemDialog(self, title="Añadir hobby (HTML)")
#         if dlg.exec():
#             self.listHobbies.addItem(dlg.value())
#
...
#
#         actOpen = QtGui.QAction("📂", self)
#         actOpen.setToolTip("Abrir JSON (Ctrl+O)")
#         actOpen.triggered.connect(self.open_file)
#         tb.addAction(actOpen)
#
#         actSave = QtGui.QAction("💾", self)
#         actSave.setToolTip("Guardar JSON (Ctrl+S)")
#         actSave.triggered.connect(self.save_file)
#         tb.addAction(actSave)
#
#         tb.addSeparator()
#
#         actTranslate = QtGui.QAction("󰊿 ", self)
#         actTranslate.setToolTip("Traducir JSON actual")
#         actTranslate.triggered.connect(self.action_translate)
#         tb.addAction(actTranslate)
#
#         actSummarize = QtGui.QAction(" ", self)
#         actSummarize.setToolTip("Resumir textos del JSON actual")
#         actSummarize.triggered.connect(self.action_summarize)
#         tb.addAction(actSummarize)
#
#         tb.addSeparator()
#
#         actExportAll = QtGui.QAction("🌍 ", self)
#         actExportAll.setToolTip("Exportar en 3 idiomas (es/en/zh) + versiones reducidas")
#         actExportAll.triggered.connect(self.action_export_all)
#         tb.addAction(actExportAll)
#
#         # Atajos opcionales
#         actOpen.setShortcut(QtGui.QKeySequence("Ctrl+O"))
#         actSave.setShortcut(QtGui.QKeySequence("Ctrl+S"))
#
#     def _ensure_loaded(self) -> bool:
#         if not self.data:
#             QtWidgets.QMessageBox.information(
#                 self, "Info", "Abre primero un JSON (Archivo → Abrir…)."
#             )
#             return False
#         return True
#
#     def action_translate(self):
#         """Traducir el JSON en memoria y guardar como nuevo archivo."""
#         if not self._ensure_loaded():
#             return
#
#         # Dialogo de opciones mínimas
#         dlg = QtWidgets.QDialog(self)
#         dlg.setWindowTitle("Traducir JSON")
#         form = QtWidgets.QFormLayout(dlg)
#
#         cbSrc = QtWidgets.QComboBox()
#         cbTgt = QtWidgets.QComboBox()
#         # Pones aquí pares que usas habitualmente:
#         langs = [
#             ("spa_Latn", "Español"),
#             ("eng_Latn", "Inglés"),
#             ("zho_Hans", "Chino simplificado"),
#             ("zho_Hant", "Chino tradicional"),
#         ]
#         for code, label in langs:
#             cbSrc.addItem(label, code)
#             cbTgt.addItem(label, code)
#         # por defecto: es -> en
#         cbSrc.setCurrentIndex(0)  # spa
#         cbTgt.setCurrentIndex(1)  # eng
#
#         form.addRow("Origen:", cbSrc)
#         form.addRow("Destino:", cbTgt)
#
#         bb = QtWidgets.QDialogButtonBox(
#             QtWidgets.QDialogButtonBox.StandardButton.Ok
#             | QtWidgets.QDialogButtonBox.StandardButton.Cancel
...
#             return
#
#         src = cbSrc.currentData()
#         tgt = cbTgt.currentData()
#         if src == tgt:
#             QtWidgets.QMessageBox.warning(self, "Aviso", "El idioma origen y destino son iguales.")
#             return
#
#         # Seleccionar salida
#         out_fn, _ = QtWidgets.QFileDialog.getSaveFileName(
#             self, "Guardar JSON traducido", "", "JSON (*.json)"
#         )
#         if not out_fn:
#             return
#
#         # Ejecutar traducción con tu módulo (si está disponible)
#         try:
#             from editor.traductor.traductor import translate_json  # type: ignore
#         except Exception as e:
#             QtWidgets.QMessageBox.critical(
#                 self,
#                 "Error",
#                 "No se pudo importar editor.traductor.traductor\n"
#                 "Asegúrate de tener el paquete instalado.\n\n"
#                 f"Detalle: {e}",
#             )
#             return
#
#         # Trabajo en progreso: bloquea UI con un cursor de espera
#         QtWidgets.QApplication.setOverrideCursor(QtCore.Qt.CursorShape.WaitCursor)
#         try:
#             translated = translate_json(self.data, src_lang=src, tgt_lang=tgt)
#             save_json(Path(out_fn), translated)
#             self.statusBar().showMessage(f"Traducido y guardado: {out_fn}")
#         except Exception as e:
#             QtWidgets.QMessageBox.critical(self, "Error al traducir", str(e))
#         finally:
#             QtWidgets.QApplication.restoreOverrideCursor()
#
#     def action_summarize(self):
#         """Resumir textos del JSON en memoria y guardar como nuevo archivo."""
#         if not self._ensure_loaded():
#             return
#
#         # Diálogo simple para ratio de resumen
#         dlg = QtWidgets.QDialog(self)
#         dlg.setWindowTitle("Resumir JSON")
#         form = QtWidgets.QFormLayout(dlg)
#
#         spRatio = QtWidgets.QDoubleSpinBox()
#         spRatio.setRange(0.05, 0.95)
#         spRatio.setSingleStep(0.05)
#         spRatio.setValue(0.3)  # por defecto 30%
#         form.addRow("Ratio (0.05-0.95):", spRatio)
#
#         bb = QtWidgets.QDialogButtonBox(
#             QtWidgets.QDialogButtonBox.StandardButton.Ok
#             | QtWidgets.QDialogButtonBox.StandardButton.Cancel
...
#             return
#
#         ratio = float(spRatio.value())
#
#         # Seleccionar salida
#         out_fn, _ = QtWidgets.QFileDialog.getSaveFileName(
#             self, "Guardar JSON resumido", "", "JSON (*.json)"
#         )
#         if not out_fn:
#             return
#
#         # Ejecutar resumen con tu módulo (si está disponible)
#         try:
#             from editor.summarizer.summarizer import summarize_json_in_memory  # type: ignore
#         except Exception as e:
#             QtWidgets.QMessageBox.critical(
#                 self,
#                 "Error",
#                 "No se pudo importar editor.summarizer.summarizer\n"
#                 "Asegúrate de tener el paquete instalado.\n\n"
#                 f"Detalle: {e}",
#             )
#             return
...
#         QtWidgets.QApplication.setOverrideCursor(QtCore.Qt.CursorShape.WaitCursor)
#         try:
#             summarized = summarize_json_in_memory(self.data, ratio=ratio)
#             save_json(Path(out_fn), summarized)
#             self.statusBar().showMessage(f"Resumido y guardado: {out_fn}")
#         except Exception as e:
#             QtWidgets.QMessageBox.critical(self, "Error al resumir", str(e))
#         finally:
#             QtWidgets.QApplication.restoreOverrideCursor()
#
#     def action_export_all(self):
#         """Guardar en lote: es/en/zh (zho_Hans) + versiones reducidas (.min)."""
#         if not self._ensure_loaded():
#             return
#
#         # Tomamos un snapshot fresco de lo que hay en las tabs (igual que Guardar)
#         snapshot: dict[str, Any] = {}
#         try:
#             snapshot["intro"] = self.tabIntro.value()
#             snapshot["works"] = self.tabWorks.value()
#             snapshot["educations"] = self.tabEdu.value()
#         except Exception as e:
#             QtWidgets.QMessageBox.critical(self, "Error", f"No se pudo recopilar datos: {e}")
#             return
#
#         # Carpeta destino
#         out_dir = QtWidgets.QFileDialog.getExistingDirectory(
#             self, "Elegir carpeta para exportación"
#         )
#         if not out_dir:
#             return
...
#         stem, ok = QtWidgets.QInputDialog.getText(
#             self, "Prefijo de archivo", "Nombre base (sin extensión):", text="cv"
#         )
...
#
#         # Parámetros del lote
#         ratio = 0.30  # reducción por defecto
#
#         # Cargamos utilidades de traducir / resumir
#         try:
#             from editor.traductor.traductor import translate_json  # type: ignore
#         except Exception as e:
#             QtWidgets.QMessageBox.critical(
...
#         QtWidgets.QApplication.setOverrideCursor(QtCore.Qt.CursorShape.WaitCursor)
#         try:
#             # Asumimos que el snapshot está en español; evitamos traducción identidad para "es".
#             src_lang = "spa_Latn"
#
...
#             # Español (original)
#             data_es = snapshot
#             produced.append((f"{stem}.es.json", data_es))
#             produced.append((f"{stem}.es.s.json", summarize_json_in_memory(data_es, ratio=ratio)))
#
#             # Inglés
#             data_en = translate_json(snapshot, src_lang=src_lang, tgt_lang="eng_Latn")
#             produced.append((f"{stem}.en.json", data_en))
#             produced.append((f"{stem}.en.s.json", summarize_json_in_memory(data_en, ratio=ratio)))
#
#             # Chino simplificado
#             data_zh = translate_json(snapshot, src_lang=src_lang, tgt_lang="zho_Hans")
#             produced.append((f"{stem}.zh.json", data_zh))
#             produced.append((f"{stem}.zh.s.json", summarize_json_in_memory(data_zh, ratio=ratio)))
#
#             # Escritura a disco
#             for fname, payload in produced:
#                 save_json(out_base_dir / fname, payload)
#
#             self.statusBar().showMessage(
#                 f"Exportado en {out_base_dir} → {', '.join(name for name, _ in produced)}"
#             )
#             QtWidgets.QMessageBox.information(
#                 self,
#                 "Exportación completada",
#                 "Se han generado los archivos:\n\n" + "\n".join(n for n, _ in produced),
#             )
#         except Exception as e:
#             QtWidgets.QMessageBox.critical(self, "Error en exportación", str(e))
#         finally:
#             QtWidgets.QApplication.restoreOverrideCursor()
#
#     # IO
...
#         self.tabEdu.load(self.data.get("educations", {}))
